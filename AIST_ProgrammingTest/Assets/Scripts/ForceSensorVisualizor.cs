...
namespace Test1
{
    ...
    public class ForceSensorVisualizor : MonoBehaviour
    {
        ...
        private void UpdateForceSensor()
        {
            ...
            this.transform.rotation = simulationSettings.useForceDirection ? 
                Quaternion.LookRotation(ToUnityVector3(sensorData.ForceReading)) :
                Quaternion.Euler(ToUnityVector3(sensorData.Orientation));
